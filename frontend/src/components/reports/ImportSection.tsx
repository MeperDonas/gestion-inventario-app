      ...
      <div className="p-5 space-y-4">
        {!hasStarted && (
          <>
            <label
              ...
              onDrop={handleDrop}
              className={cn(
                "block rounded-xl border border-dashed px-4 py-8 text-center cursor-pointer transition-colors",
                dragActive
        ...
        {hasStarted && (
          <>
            ...
            {status?.warningCount ? (
              <div className="rounded-lg border border-amber-300/50 bg-amber-50/70 px-3 py-2 text-sm text-amber-800">
