...
COMMIT: Todo se persiste
    ↓
Generar factura PDF en Cloudinary
    ↓
...
**Para empezar:**
> "Este diagrama muestra paso a paso cómo procesamos una venta, desde que el cajero escanea el primer producto hasta que se genera la factura."
