...
**Design doc:** `docs/planes/historicos/2026-03-05-deployment-design.md` (sections 3.1-3.10)
...
See `docs/planes/historicos/2026-03-05-deployment-design.md` sections 4.1-4.5 for detailed steps.
