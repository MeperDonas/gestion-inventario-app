...
export declare class SalesService {
    ...
    update(id: string, updateSaleDto: UpdateSaleDto, userId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        userId: string;
    ...
    generateInvoice(id: string, response: Response): Promise<void>;
    private getTaxRate;
    private formatCurrencyCompact;
